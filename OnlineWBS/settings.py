...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_PATH,'WBS/static'),
)
...
SECRET_KEY = '8avn954v&amp;m@@m5bkw168=@8_70h%*z&amp;p-#f04p1!g3ywqu56ob'
...
WSGI_APPLICATION = 'OnlineWBS.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(PROJECT_PATH,'WBS/templates'),
)
